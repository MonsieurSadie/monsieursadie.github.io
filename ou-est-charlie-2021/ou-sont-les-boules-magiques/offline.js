{
	...
	"fileList": [
		...
		"jquery-3.4.1.min.js",
		"offlineClient.js",
		"images/vaisseaufreezer-sheet0.png",
		"images/champs-sheet0.png",
		"images/doyen-sheet0.png",
		"images/ile-sheet0.png",
		...
		"media/water_sound.ogg",
		"media/collect.ogg",
		"media/arbre.ogg",
		"media/yt1s.com_-_sliding_on_dirt_sound_effect_for_editing (1).ogg",
		"media/musicjeu.ogg",
		"media/vaisseau (1).ogg",
		"media/grotte.ogg",
		"media/sans titre.ogg",
		"media/roi.ogg",
		"icon-16.png",
		"icon-32.png",
		"icon-114.png",
